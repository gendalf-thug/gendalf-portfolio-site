...
В написании кода React native мы всегда придерживаемся данного стандарта. Если вам кажется что чего то не хватает, вы всегда можете написать об этом в issues [данного репозитория](https://github.com/taZik616/gendalf-portfolio-site) или открыть PR(pull request). Мы рассматриваем предложения и постараемся ответить вам как можно быстрее.
